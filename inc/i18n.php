...
function artisraw_fr_dict() {
	...
	$d = array(
		...
		'Custom branding'            => 'Personnalisation de marque',
			...
			'Discover our product' => 'Découvrir nos produits',
			...
			'Creators of handmade Tunisian olive wood collections for retailers, distributors, hospitality groups, corporate gifts and private-label brands.' => 'Créateurs de collections de bois d’olivier tunisien fait main pour détaillants, distributeurs, hôtellerie, cadeaux d’affaires et marques en marque blanche.',
			...
			'Born in Sfax, Tunisia — the heart of Mediterranean olive country — ArtisRaw gives century-old Chemlali olive trees a second life handcrafted pieces that retailers, distributors and brands actually want on their shelves. Cutting boards, tableware, utensils, chess sets: every item is shaped by hand, finished with food-safe mineral oil and beeswax, and built to sell. We’re ISO 9001:2015 certified, we ship to over 30 countries, and we keep things simple —stock items out the door in 72 hours, custom production in 6 to 8 weeks. Whether you need sale-ready , private label or full export documentation, ArtisRaw gives you factory-direct quality without the guesswork.' => 'Né à Sfax, en Tunisie — au cœur du pays de l’olivier méditerranéen — ArtisRaw offre une seconde vie à des oliviers Chemlali centenaires sous forme de pièces artisanales que les détaillants, distributeurs et marques veulent vraiment sur leurs étagères. Planches à découper, art de la table, ustensiles, jeux d’échecs : chaque article est façonné à la main, fini à l’huile minérale alimentaire et à la cire d’abeille, et conçu pour se vendre. Nous sommes certifiés ISO 9001:2015, nous expédions dans plus de 30 pays, et nous gardons les choses simples — articles en stock expédiés sous 72 heures, production sur mesure en 6 à 8 semaines. Que vous ayez besoin de collections prêtes à vendre, de marque blanche ou d’une documentation d’export complète, ArtisRaw vous offre une qualité directe d’usine, sans approximation.',
			'From olive tree to premium collections' => 'De l’olivier aux collections premium',
			'From Olive Tree to Premium Collections' => 'De l’olivier aux collections premium',
			'More info' => 'Plus d’infos',
			'Born in Sfax, Tunisia — the heart of Mediterranean olive country — ArtisRaw gives century-old Chemlali olive trees a second life handcrafted pieces that retailers, distributors and brands actually want on their shelves.' => 'Né à Sfax, en Tunisie — au cœur du pays de l’olivier méditerranéen — ArtisRaw offre une seconde vie à des oliviers Chemlali centenaires sous forme de pièces artisanales que les détaillants, distributeurs et marques veulent vraiment sur leurs étagères.',
			'Cutting boards, tableware, utensils, chess sets: every item is shaped by hand, finished with food-safe mineral oil and beeswax, and built to sell. We’re ISO 9001:2015 certified, we ship to over 30 countries, and we keep things simple —stock items out the door in 72 hours, custom production in 6 to 8 weeks.' => 'Planches à découper, art de la table, ustensiles, jeux d’échecs : chaque article est façonné à la main, fini à l’huile minérale alimentaire et à la cire d’abeille, et conçu pour se vendre. Nous sommes certifiés ISO 9001:2015, nous expédions dans plus de 30 pays, et nous gardons les choses simples — articles en stock expédiés sous 72 heures, production sur mesure en 6 à 8 semaines.',
			'Whether you need sale-ready , private label or full export documentation, ArtisRaw gives you factory-direct quality without the guesswork.' => 'Que vous ayez besoin de collections prêtes à vendre, de marque blanche ou d’une documentation d’export complète, ArtisRaw vous offre une qualité directe d’usine, sans approximation.',
